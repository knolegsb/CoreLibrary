...
{
    public static class LibraryContextSeedData
    {
        public static void LibraryContextSeedDataInitializer(this LibraryContext context)
        {
            // first, clear the database. This ensures we can always start
            // fresh with each demo. Not advised for production enviroments, obviously..
